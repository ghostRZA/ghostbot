...
Funbot.misc.ball = [
" [:8ball:] It is certain",
" [:8ball:] It is certainly.. not.",
" [:8ball:] Without a doubt",
" [:8ball:] Yes definitely",
" [:8ball:] You may rely on it",
" [:8ball:] Probalby yes maybe no.",
" [:8ball:] Sorry. Im married!",
" [:8ball:] Never in your life!",
" [:8ball:] >.> not answering that.",
" [:8ball:] Zzzzzz.. what did you say?",
" [:8ball:] y-yyes senpai!",
" [:8ball:] n-nnoo.. baka!!",
" [:8ball:] Most likely",
" [:8ball:] All looks good",
" [:8ball:] Yes",
" [:8ball:] no",
" [:8ball:] b-but.. do i look fat in this dress?",
...
Funbot.misc.roll = [
"You rolled A 1. HAHA! :(",
"You rolled A 2. Just like porkbot :(",
"You rolled A 3. Average.. :("];

Funbot.misc.roll2 = [
"4. Awesome!",
"5. Awesome!",
"6. Awesome! But porkbot is still @ghostR 's"];
...
" You will inherit nothing! HA -porkbot did that to me-.",
" You will live a long, happy life. JK.",
" A friend asks only for your time, not your money. But will ask for both.",
" You will not be invited to an exciting event."];
